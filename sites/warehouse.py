...
class Warehouse:
    ...
    def __init__(self, net):
        ...
        net.addLink(self.ic1, self.sw_piso1)
        net.addLink(self.ship1, self.sw_piso1)
        net.addLink(self.recv1, self.sw_piso1)
        net.addLink(self.sec1, self.sw_piso1)
        net.addLink(self.cam1, self.sw_piso1)

        net.addLink(self.office1, self.sw_piso2)
        net.addLink(self.prt1, self.sw_piso2)
        net.addLink(self.phone1, self.sw_piso2)
        net.addLink(self.cam2, self.sw_piso2)

        net.addLink(self.sw_piso1, self.sw_dist)
        net.addLink(self.sw_piso2, self.sw_dist)

        net.addLink(self.sw_dist, self.mls)
